		...
		if(auth == null || auth.getPrincipal() == "anonymousUser")    //Su dung cookie de luu
		{
			...
			for(int i=0;i<clientCookies.length;i++)
			{
				...
				{						
					...
					clientCookies[i].setPath("/phoneshop");
