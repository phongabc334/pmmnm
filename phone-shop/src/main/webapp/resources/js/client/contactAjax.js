function sendContact()
{
	...
	$.ajax({
			...
			url: "http://localhost:8080/phoneshop/createContact",
			success: function(result){
				alert("Cảm ơn quý khách đã liên hệ với chúng tôi. phone shop sẽ phản hồi sớm cho các bạn");
				window.location.href = "/phoneshop/contact";
			},
			error : function(e){
				alert("Error: ",e);
				console.log("Error" , e );
