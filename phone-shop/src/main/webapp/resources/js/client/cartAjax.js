...
function changeQuanity(id,value,price)
	{
		$.ajax({
			type: "GET",		
			url: "http://localhost:8080/phoneshop/api/gio-hang/changSanPhamQuanity?id="+id+"&value="+value,
...
function deleteFromCart(id)
{
	$.ajax({
		type: "GET",		
		url: "http://localhost:8080/phoneshop/api/gio-hang/deleteFromCart?id="+id,
		success: function(result){
