$(document).ready(function() {
	...
	function ajaxGet(page){		
		...
		$.ajax({
			...
			url: "http://localhost:8080/phoneshop/api/lien-he/all" + '?page=' + page,
...
//		event.preventDefault();
	...
	$(document).on('click', '.btnChiTiet', function (event){
		...
		var href = "http://localhost:8080/phoneshop/api/lien-he/"+lienHeId;
	...
	function ajaxPostReply(){
    	...
    	$.ajax({
			...
			type : "POST",
			contentType : "application/json",
			url : "http://localhost:8080/phoneshop/api/lien-he/reply",
