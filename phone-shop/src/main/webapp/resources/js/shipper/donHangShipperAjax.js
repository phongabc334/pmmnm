$(document).ready(function() {
	...
	function ajaxGet(page){		
		...
		$.ajax({
			...
			url: "http://localhost:8080/phoneshop/api/shipper/don-hang/all" + '?page=' + page,
...
//		event.preventDefault();
	...
	$(document).on('keyup', '#searchById', function (event){
		...
		if(donHangId != ''){
    	  $('.donHangTable tbody tr').remove();
    	  $('.pagination li').remove();
		  var href = "http://localhost:8080/phoneshop/api/shipper/don-hang/"+donHangId;
...
//    	 console.log(data);
    	 $.ajax({
 			...
 			type : "POST",
 			contentType : "application/json",
 			url : "http://localhost:8080/phoneshop/api/shipper/don-hang/update",
