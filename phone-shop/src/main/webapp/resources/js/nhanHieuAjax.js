$(document).ready(function(){
	...
	function ajaxGet(page){
		$.ajax({
			type: "GET",		
			url: "http://localhost:8080/phoneshop/api/nhan-hieu/all?page=" + page,
	...
	function ajaxPost(){
    	...
    	$.ajax({
			...
			url : "http://localhost:8080/phoneshop/api/nhan-hieu/save",
    ...
    $(document).on("click",".btnCapNhatNhanHieu",function(){
		...
		var href = "http://localhost:8080/phoneshop/api/nhan-hieu/" + nhanHieuId;
    ...
    function ajaxPut(){
    	...
    	$.ajax({
			...
			type : "PUT",
			contentType : "application/json",
			url : "http://localhost:8080/phoneshop/api/nhan-hieu/update",
			data : JSON.stringify(formData),
            // dataType : 'json',
			success : function(response) {
    ...
    $(document).on("click",".btnXoaNhanHieu", function() {
		...
		if(confirmation){
		  $.ajax({
			  type : "DELETE",
			  url : "http://localhost:8080/phoneshop/api/nhan-hieu/delete/" + nhanHieuId,
