				...
				<div class="modal-dialog modal-lg" role="document"
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="row">
								<div class="form-group col-md-6">
									<label for="inputPassword4">Thiết kế</label> <input
										type="text" class="form-control" id="thietKe"
										name="thietKe">
								</div>
								<div class="form-group col-md-6">
									<label for="inputPassword4">Màu sắc</label> <input
										type="text" class="form-control" id="mauSac"
										name="mauSac">
								</div>
							</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="row">
								...
								<div class="form-group col-md-6">
									<label for="inputState">Hãng Sản Xuất</label> <select
										name="nhaSXId" id="nhaSXId" class="form-control">
										<c:forEach var="nhanHieu" items="${listNhanHieu }">
											<option value="${nhanHieu.id }">${nhanHieu.tenHangSanXuat}
											</option>
										</c:forEach>
							...
							<div class="row">
								<div class="form-group col-md-6">
									<label for="inputPassword4">Camera sau</label> <input
										type="text" class="form-control" id="camSau"
										name="cameraSau">
								</div>
								<div class="form-group col-md-6">
									<label for="inputPassword4">Camera trước</label> <input
										type="text" class="form-control" id="camTruoc"
										name="cameraTruoc">
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group col-md-6">
									<label for="inputPassword4">Hệ điều hành</label> <input
										type="text" class="form-control" id="haDieuHanh"
										name="heDieuHanh">
								</div>
								<div class="form-group col-md-6">
									<label for="inputPassword4">Màn hình</label> <input
										type="text" class="form-control" id="manHinh"
										name="manHinh">
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="form-group col-md-6">
									<label for="inputPassword4">Dung lượng pin</label> <input
										type="text" class="form-control" id="dungLuongPin"
										name="dungLuongPin">
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="form-group col-md-6">
									<label for="inputPassword4">Sim</label> <input
										type="text" class="form-control" id="sim"
										name="sim">
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group col-md-6">
									<label for="inputPassword4">CPU</label> <input
										type="text" class="form-control" name="cpu" >
								</div>

								<div class="form-group col-md-6">
									<label for="inputPassword4">RAM</label> <input
										type="text" class="form-control" name="ram" >
								</div>
							</div>
							<div class="row">
								<div class="form-group col-md-6">
									<label for="inputPassword4">ROM</label> <input
										type="text" class="form-control" name="rom" >
								</div>
								<div class="form-group col-md-6">
									<label for="inputPassword4">Sạc tối đa</label> <input
										type="text" class="form-control" name="sacToiDa" >
								</div>
							</div>
							<div class="row">
								<div class="form-group col-md-6">
								...
								<div class="form-group col-md-6">
									<label for="inputEmail4">Bảo mật</label> <input
										type="text" class="form-control" name="baoMat">
								</div>
