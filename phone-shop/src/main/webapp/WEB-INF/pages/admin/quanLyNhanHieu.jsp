...
<body>
	...
	<div class="col-md-10">
      <h3 class="page-header">Quản lý Hãng</h3>

      <button class="btn btn-success btnThemNhanHieu">Thêm mới Hãng</button>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalLabel">Tạo mới/Cập nhật Hãng</h5>
