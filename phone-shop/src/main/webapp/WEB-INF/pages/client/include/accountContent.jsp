				...
				<div class="row">
					...
					<div class="col-md-6">
						<h5 style="line-height: 2;">
							<span style:">Họ tên: </span>${user.getHoTen()}</h5>
						<h5 style="line-height: 2;">
							<span">Số điện thoại: </span>${user.getSoDienThoai()}</h5>
						<h5 style="line-height: 2;">
							<span ">Email: </span>${user.getEmail()}</h5>
						<h5 style="line-height: 2;">
							<span> Địa chỉ: </span>${user.getDiaChi()}</h5>
